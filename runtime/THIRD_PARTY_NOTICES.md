...
Generated from [`deps/MANIFEST.toml`](deps/MANIFEST.toml) by `scripts/deps-check.py --notices`. Do not edit by hand.

The Tessel 2 runtime statically links or incorporates the following third-party components:
...
| nodejs-test-suite | MIT | https://github.com/nodejs/node |
